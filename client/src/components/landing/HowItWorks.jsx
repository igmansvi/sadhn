          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 relative z-10">
            {steps.map((item, index) => (
              ...
              >
                {/* Step Circle */}
                <div
                  className={`w-24 h-24 bg-gradient-to-br ${item.gradient} rounded-full shadow-lg flex items-center justify-center text-4xl mb-6 hover:scale-110 transition-transform duration-300 border-4 border-white`}
                >
                  {item.step}
                </div>
