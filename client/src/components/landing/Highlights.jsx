  ...
  const highlights = [
    {
      ...
      subtext: 'Empowering individuals across India with industry-ready skills.',
      gradient: 'from-orange-100 to-orange-50'
    },
    {
      icon: '🏢',
      heading: '500+ Hiring Partners',
      subtext: 'Connect with verified companies actively seeking skilled talent.',
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Join millions of learners transforming their careers with industry-recognized skills and certifications
          </p>
        </div>
