...
import { Search, MapPin, Clock, Building, Briefcase, X } from "lucide-react";
...
export default function JobsPage() {
    ...
    const fetchJobs = async (params) => {
        ...
        try {
            ...
            if (cleanParams.search) {
                ...
                response = await jobService.searchJobs(searchParams);
            } else {
                response = await jobService.getJobs(cleanParams);
            }
    ...
    useEffect(() => {
        fetchJobs(filters);
    }, [filters.employmentType, filters.workMode, filters.page, filters.search]);
        ...
        <div className="container mx-auto p-6">
            ...
            >
                <h1 className="text-3xl font-bold">
                    Find <span className="gradient-text">Jobs</span>
                </h1>
                                            ...
                                            <CardContent className="p-6">
                                                <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
                                                    ...
                                                    <div className="flex flex-row md:flex-col items-center md:items-end gap-2">
                                                        <Badge className="gradient-primary text-primary-foreground">{job.employmentType}</Badge>
