                ...
                <div className="grid lg:grid-cols-3 gap-6">
                    <div className="lg:col-span-1 space-y-3 max-h-[calc(100vh-280px)] overflow-y-auto">
                        {filteredApplications.map((app) => (
                            ...
                            >
                                <Card
                                    className={`cursor-pointer transition-all shadow-lg ${selectedApp?._id === app._id ? "ring-1 ring-primary bg-gradient-to-br from-primary/5 to-secondary/5" : "hover:shadow-xl hover:border-primary/50"}`}
